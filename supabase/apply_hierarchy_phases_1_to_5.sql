-- ============================================================================
-- PlayHub - org hierarchy re-architecture, combined (ALL hierarchy migrations).
--
-- Paste-and-run in the Supabase SQL editor. Applies the hierarchy migrations
...
--
-- NOTE: includes the 000600/000700/000800 follow-ups (head_coach null-sport
-- relaxation; head_coach+coach student create; head_coach coach-record create)
-- so this matches a fresh 'supabase db reset' exactly.
-- ============================================================================
...
-- ============================================================================
-- All hierarchy migrations applied. Review the result, then commit:
commit;
